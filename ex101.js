...
const username = emailAddress.slice(0, indexOfAt);
// use the indexOfAt variable you defined above along with a string method to create a username as described in the starting comments
...
console.log('The new email addres is ${newEmailAddres}');

const firstFive = username.slice(0, 5)
//can stil put const tempPassword = username.slice(0, 5) + emailLength  dont have to create a new variable firstFive
const tempPassword = firstFive + emailLength//use string methods and either concatenation or interpolation to generate the temporary password as described in the starting comments, you might find it useful to create another variable above this line to do this
